...
db.getCollection('projects').insertMany(
    [
        ...
        },
        {
            ...
            imageUrl: 'https://cdn.dribbble.com/userupload/7531024/file/original-28960363b0b1e5a03c2f6f1f077c298e.jpg?compress=1&resize=1504x1128',
            title: 'Education App UIX',
            gitDemoUrl: 'https://github.com',
            demoUrl: 'https://dribbble.com/shots/21637001-Education-App-UIX',
        },
        {
            imageUrl: 'https://cdn.dribbble.com/userupload/7474794/file/original-ec5e3ff0615f4ec018a8662d76206bde.jpg?compress=1&resize=1504x1126',
            title: 'Recipe app design',
            gitDemoUrl: 'https://github.com',
            demoUrl: 'https://dribbble.com/shots/21617723-Recipe-app-design',
        },
        {
        
            imageUrl: 'https://cdn.dribbble.com/userupload/7527073/file/original-a56488a4a04a23bfbeb97cafc030dde5.png?compress=1&resize=1504x1128',
            title: 'OnStep - Shoes Store',
            gitDemoUrl: 'https://github.com',
            demoUrl: 'https://dribbble.com/shots/21635811-OnStep-Shoes-Store',
        },
        {
